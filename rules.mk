...
build/linux-amd64/gallon: $(gallon_SOURCES) $(SOURCES)
	env GOTRACEBACK=none CGO_ENABLED=0 GOARCH=amd64 GOOS=linux $(GOBUILD) $(FLAGS) $(LDFLAGS) -o $@ ./cmd/gallon

build/darwin-amd64/gallon: $(gallon_SOURCES) $(SOURCES)
	env GOTRACEBACK=none CGO_ENABLED=0 GOARCH=amd64 GOOS=darwin $(GOBUILD) $(FLAGS) $(LDFLAGS) -o $@ ./cmd/gallon

build/linux-arm7/gallon: $(gallon_SOURCES) $(SOURCES)
	env GOTRACEBACK=none CGO_ENABLED=0 GOARM=7 GOARCH=arm GOOS=linux $(GOBUILD) $(FLAGS) $(LDFLAGS) -o $@ ./cmd/gallon
